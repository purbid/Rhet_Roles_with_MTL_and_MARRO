...
class Attn_CRF(nn.Module):
    def __init__(self, n_tags, sent_emb_dim, sos_tag_idx, eos_tag_idx, pad_tag_idx, vocab_size=0, word_emb_dim=0,
        ...
        self.fc = nn.Linear(sent_emb_dim, n_tags).to(self.device)
    ...
    def forward(self, x, y=[]):
        ...
        attn_mask = attention_padding_mask(tensor_x, y_tensor, padding_index=0).to(self.device)  # (B, T, T)
